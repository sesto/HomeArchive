					...
					[
							...
							function($scope, $upload) {
								...
								$scope.onFileSelect = function($files) {
									...
									/*
									 * alternative way of uploading, send the
									 * file binary with the file's content-type.
									 * Could be used to upload files to CouchDB,
									 * imgur, etc... html5 FileReader is needed.
									 * It could also be used to monitor the
									 * progress of a normal http post/put
									 * request with large data
									 */
