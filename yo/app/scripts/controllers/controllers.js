...
homearchiveControllers.controller('FileListCtrl', [
		...
		function($scope, FileService, ngTableParams) {
			...
			$scope.edit = function(file) {
				...
				$scope.tag1 = file.tags[1];
				$scope.tag1 = file.tags[2];
				scopeFile = file;
								...
								for (var i = 0; i < $files.length; i++) {
									...
									$scope.upload = $upload
											.upload(
													...
													// file(s)
													// customize file formData
													// name
													// ('Content-Disposition'),
													// server side file variable
													// name.
													// fileFormDataName: myFile,
													// //or a list of names for
													// multiple files (html5).
													// Default is 'file'
													// customize how data is
													// added to formData. See
